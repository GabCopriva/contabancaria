...
public class ContaController implements ContaRepository {
	...
	public void cadastrar(Conta conta) {
		...
		System.out.println("\nA Cona número: " +conta.getNumero()+ " foi criada com sucesso!");
	...
	public void sacar(int numero, float valor) {
		var buscaConta = buscarNaCollection(numero);
			if (buscaConta != null) {
				...
				System.out.println("\nO saqui na conta número: " +numero+ " ofi efetuado com sucesso!");
			} else {
				System.out.println("\nA conta número " +numero+ " não foi encontrada!");
			}
	}
	...
	public void depositar(int numero, float valor) {
			var buscaConta = buscarNaCollection(numero);
				...
				System.out.println("\nO depósito na conta número " +numero+ " foi efetuado com sucesso!");
					...
					System.out.println("\nA conta numero " +numero+ " não foi enonctrada ou a Conta destino não é uma Conta Correne");
	}
	...
	public void tranferir(int numeroOrigem, int numeroDestino, float valor) {
		...
		if (buscaContaOrigem != null && buscaContaDestino != null) {
			if (listaContas.get(listaContas.indexOf(buscaContaOrigem)).sacar(valor) == true){
				...
				System.out.println("\nA conta de prigem e/ou destino não foram encontradas!");
		}
